...
Которые:
* Устанавливают nginx на slave1 и slave2
* Перенастраивают nginx на utf-8
* Перезагружают его после настройки
* Изменяют страничку "по умолчанию". На этой странице должен выводиться:
  * Русский текст
  * Полное ФИО студента
